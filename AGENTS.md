...
Inner rails are 30px felt-toned cushions with diagonal mouths: side jaws match their 46px pockets and slope outward toward the side pockets, while 60px corner jaws slope away from each corner pocket. Keep the 60px corner jaw length and its steep slope. At the corner-side vertices, use the 46px rim diameter divided by √2 so the diagonal gap is exactly the full rim width; do not widen the side-pocket mouths or the playing-surface end of the corner jaws. Corner rail collision uses the matching narrow diagonal boundary, motion toward both sides of the target corner, and a sufficiently diagonal approach, preventing shallow-angle clipping through a jaw; do not alter other pocket physics when changing rails.
