...
Pocket capture checks must account for the ball's full movement segment during a physics step, so high-speed entries sink instead of stepping through a pocket and rebounding out.
