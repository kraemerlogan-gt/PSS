...
Inner rails are 30px felt-toned cushions with diagonal mouths: side jaws match their 46px pockets and slope outward toward the side pockets, while 60px corner jaws slope away from each corner pocket. Draw each corner mouth from the inner rail corner plus the 60px jaw length, so its diagonal opening fully clears the corner well. Corner rail collision uses the matching narrow diagonal boundary, motion toward both sides of the target corner, and a sufficiently diagonal approach, preventing shallow-angle clipping through a jaw; do not alter other pocket physics when changing rails.
