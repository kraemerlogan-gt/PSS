...
Side pockets are visual-only 46px circular wells centered on the inner wood edge; their leather rims must use the same shared 46px diameter and offset, with `border-radius: 50%` and no legacy side-pocket backing layers.
