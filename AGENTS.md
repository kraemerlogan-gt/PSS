...
Inner rails are 30px felt-toned cushions with diagonal mouths: side jaws match their 46px pockets and slope outward toward the side pockets, while 60px corner jaws slope away from each corner pocket. Keep the 60px corner jaw length, but inset only its corner-side rail vertices by the 46px well diameter so the opening directly adjacent to each corner well clears it; do not widen the side-pocket mouths or the playing-surface end of the corner jaws. Corner rail collision uses the matching narrow diagonal boundary, motion toward both sides of the target corner, and a sufficiently diagonal approach, preventing shallow-angle clipping through a jaw; do not alter other pocket physics when changing rails.
