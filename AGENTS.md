...
Inner rails are 30px felt-toned cushions with diagonal mouths: side jaws match their 46px pockets and slope outward toward the side pockets, while corner mouths are 120px wide with steep faces. Corner rail collision requires both the tapered-mouth position and motion toward both sides of the target corner, preventing clipping through a jaw; do not alter other pocket physics when changing rails.
